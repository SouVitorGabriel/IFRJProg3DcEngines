...
namespace BielWorld
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            this.sea = new _Sea(GraphicsDevice, this, @"Textures\sea", @"Effect\Effect3");

            this.forest = new _Forest(this);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            this.highMap.Update(gameTime);

            this.sea.Update(gameTime);

            this.forest.Update(gameTime, this.camera);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            this.highMap.Draw(this.camera);
            this.sea.Draw(this.camera);

            this.forest.Draw(camera);
