...
namespace BielWorld
{
    public class _Helicopter
    {
        ...
        public _Helicopter(GraphicsDevice graphicDevice, Game game)
        {
            ...
            //this.boundingBox = new BoundingBox();
            this.boundingBox.Min = new Vector3(-5, 3, -12);
            this.boundingBox.Max = new Vector3(5, 11, 0);
            //this.iniPosition = Vector3.Zero;
            ...
            this.sides = new _Quad[]
            {
               ...
               // 
                ...
                new _Quad(this.device, this.game, this.texHeli, new Vector3(0, 3f, -6f), new Vector2(10, 12), _WallOrientation.Down), //assoalho 
            };
        ...
        public void CreateTranslation(float x, float y, float z)
        {
            ...
            this.boundingBox.Min = new Vector3(-8 + x, 0 + y, -14 + z - 6);
            this.boundingBox.Max = new Vector3(8 + x, 15 + y, 2 + z - 6);
        ...
        {
            this.boundingBox.Min = this.Position + new Vector3(-8, 0+12, -14);
            this.boundingBox.Max = this.Position + new Vector3(8, 15+12, 2);
        }
        ...
        public _MachineState GetMachineState()
        {
            return this.state;
        }
        #endregion
