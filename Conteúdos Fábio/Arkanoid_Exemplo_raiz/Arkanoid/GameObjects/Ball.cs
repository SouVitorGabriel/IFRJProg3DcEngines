...
namespace Arkanoid
{
    public class Ball : GameObject
    {
        ...
        public override void Update(Rectangle clientBounds)
        {
            ...
            if (this.Position.X < 0 || this.Position.X > GlobalInfo.WIDTH - 200 - this.Texture.Width)
                this.Speed = new Vector2(-Speed.X, Speed.Y);

            if (this.Position.Y < 0 || this.Position.Y > GlobalInfo.HEIGHT - this.Texture.Height)
                this.Speed = new Vector2(Speed.X, -Speed.Y);
